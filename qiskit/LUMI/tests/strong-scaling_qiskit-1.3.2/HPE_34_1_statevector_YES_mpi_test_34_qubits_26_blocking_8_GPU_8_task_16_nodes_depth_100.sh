...
#SBATCH --job-name=HPE_34_1_statevector_YES_mpi_test_34_qubits_26_blocking_8_GPU_8_task_16_nodes_depth_100   # Job name
#SBATCH --output=test-results_depth_100/HPE_34_1_statevector_YES_mpi_test_34_qubits_26_blocking_8_GPU_8_task_16_node_depth_100.o%j # Name of stdout output file
#SBATCH --error=test-results_depth_100/HPE_34_1_statevector_YES_mpi_test_34_qubits_26_blocking_8_GPU_8_task_16_node_depth_100.e%j  # Name of stderr error file
...
export LUMI_QISKIT_SINGULARITY_WRAPPER_GPU_PATH=$PATH_TO_REPO/singularity-recipes/qiskit/LUMI/tests/run-singularity-with-gpu-affinity
...
export SINGULARITYENV_NUMBER_OF_QUBITS=34
...
export SINGULARITYENV_NUMBER_OF_BLOCKING_QUBITS=26

export SINGULARITYENV_CIRCUIT_DEPTH=100
