...
#SBATCH --job-name=HPE_42_1_statevector_YES_mpi_test_42_qubits_29_blocking_8_GPU_8_task_256_nodes_depth_30   # Job name
#SBATCH --output=test-results_depth_30/HPE_42_1_statevector_YES_mpi_test_42_qubits_29_blocking_8_GPU_8_task_256_node_depth_30.o%j # Name of stdout output file
#SBATCH --error=test-results_depth_30/HPE_42_1_statevector_YES_mpi_test_42_qubits_29_blocking_8_GPU_8_task_256_node_depth_30.e%j  # Name of stderr error file
...
export SINGULARITYENV_NUMBER_OF_QUBITS=42
