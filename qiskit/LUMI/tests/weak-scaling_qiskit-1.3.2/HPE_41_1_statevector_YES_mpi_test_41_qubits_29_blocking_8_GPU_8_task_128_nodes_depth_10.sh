...
#SBATCH --job-name=HPE_41_1_statevector_YES_mpi_test_41_qubits_29_blocking_8_GPU_8_task_128_nodes_depth_10   # Job name
#SBATCH --output=test-results_depth_10/HPE_41_1_statevector_YES_mpi_test_41_qubits_29_blocking_8_GPU_8_task_128_node_depth_10.o%j # Name of stdout output file
#SBATCH --error=test-results_depth_10/HPE_41_1_statevector_YES_mpi_test_41_qubits_29_blocking_8_GPU_8_task_128_node_depth_10.e%j  # Name of stderr error file
