# r-env-singularity (R 4.2.1) R package installations
...
# Set Bioconductor version to 3.15
BiocManager::install(version = "3.15", lib = libpath, ask = FALSE)
...
# geoR, geoRglm removed due to reliance on RandomFields, which was deprecated.
...
setwd("/appl/soft/math/r-env/421/421-source")
...
# install most recent rstan and hope for the best, if not, v 2.19.3 has worked OK
...
# rstanarm (downgrade to e.g. 2.19.3 if necessary)
