# r-env (R 4.5.1) R package installations
...
# Set Bioconductor version to 3.21
BiocManager::install(version = "3.21", lib = libpath, ask = FALSE)
...
setwd("/appl/soft/math/r-env/451/451-source")
...
# compilation fails in 4.5.0, out of memory
