# r-env (R 4.4.2) R package installations
...
# Set Bioconductor version to 3.20
BiocManager::install(version = "3.20", lib = libpath, ask = FALSE)
...
# maptools removed from CRAN in 2023 but installed fine in 4.4.2? 
