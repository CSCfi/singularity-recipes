# r-env (R 4.3.0) R package installations
...
BiocManager::install(version = "3.17", lib = libpath, ask = FALSE)
...
# FD
# normal install_version(...) gave error about character strings, source installation works.
# wget https://cran.r-project.org/src/contrib/FD_1.0-12.1.tar.gz
# defaultwd <- getwd()
# setwd("/appl/soft/math/r-env/430/430-source")
# install.packages("FD_1.0-12.1.tar.gz", repos = NULL, type = "source", lib = libpath)
# setwd(defaultwd)
...
# L
install_version("landscapemetrics", dependencies = FALSE, lib = libpath) # added 30 Aug 2023, not tested as part of wider script
...
# replaced with development version:
...
# soundecology + warbleR + dependencies
...
# fastDummies (Seurat 5.0.1 dependency)
...
# TITAN2 (makers currently recommend installation from Github)
#install_version("TITAN2", dependencies = FALSE, lib = libpath)
install_github("dkahle/TITAN2", dep = FALSE, lib = libpath)

# variancePartition and dependencies
