# r-env (R 4.5.2) R package installations
# the container sets up a date-locked CRAN snapshot

# when running, check:
# Bioconductor version, paths with R version number, OpenMPI version for Rmpi and pbdMPI
...
BiocManager::install(version = "3.22", lib = libpath, ask = FALSE)
...
# RandomFieldUtils removed from CRAN, compilation fails
...
# maptools removed from CRAN in 2023, compilation fails in 4.5.1
...
# rio (package moved later)
install_version("openxlsx", dependencies = FALSE, lib = libpath)
install_version("writexl", dependencies = FALSE, lib = libpath)
...
# recipes
# recent versions want future.apply, installing with dependencies = TRUE (not anymore in 2024, changed)
...
install_version("diagram", dependencies = FALSE, lib = libpath)
install_version("prodlim", dependencies = FALSE, lib = libpath)
install_version("ipred", dependencies = FALSE, lib = libpath)
install_version("sparsevctrs", dependencies = FALSE, lib = libpath)
...
# rgdal and rgeos removed from CRAN in 2023
...
install_version("kableExtra", dependencies = FALSE, lib = libpath)
...
#install_version("BIEN", dependencies = FALSE, lib = libpath)
#install_version("rangeModelMetadata", dependencies = FALSE, lib = libpath)
install_version("predicts", dependencies = FALSE, lib = libpath)
#install_version("ENMeval", dependencies = FALSE, lib = libpath)
...
install_version("DEoptim", dependencies = FALSE, lib = libpath)
...
install_version("ggstats", dependencies = FALSE, lib = libpath)
install_version("ggstats", dependencies = FALSE, lib = libpath)
...
install_version("irr", dependencies = FALSE, lib = libpath)
...
BiocManager::install("AnnotationDbi", lib = libpath, update = FALSE)
...
install_version("smoother", dependencies = FALSE, lib = libpath)
...
install_version("RcppParallel", dependencies = FALSE, lib = libpath)
...
install_version("testthat", dependencies = FALSE, lib = libpath)
install_version("fastDummies", dependencies = FALSE, lib = libpath)
...
# update OpenMPI version as needed, check path variables at the end of def file

install_version("Rmpi", dependencies = FALSE,
configure.args='--with-Rmpi-include=/usr/mpi/gcc/openmpi-4.1.7rc1/include --with-Rmpi-libpath=/usr/mpi/gcc/openmpi-4.1.7rc1/lib64 --with-Rmpi-type=OPENMPI', lib = libpath)

install_version("doMPI", dependencies = FALSE, lib = libpath)

install_version("pbdMPI", dependencies = FALSE, 
configure.args='--with-mpi-include=/usr/mpi/gcc/openmpi-4.1.7rc1/include --with-mpi-libpath=/usr/mpi/gcc/openmpi-4.1.7rc1/lib64 --with-mpi-type=OPENMPI', 
lib = libpath)
...
install_version("Rnanoflann", dependencies = FALSE, lib = libpath)
...
install_version("interleave", dependencies = FALSE, lib = libpath)
...
install_version("pan", dependencies = FALSE, lib = libpath)
#install_version("ordinal", dependencies = FALSE, lib = libpath)
#install_version("jomo", dependencies = FALSE, lib = libpath)
#install_version("mitml", dependencies = FALSE, lib = libpath)
...
BiocManager::install("BiocFileCache", lib = libpath, update = FALSE)
...
# monocle dependency qlcMatrix removed from CRAN (monocle3 available)
...
BiocManager::install("BSgenome.Hsapiens.UCSC.hg38", lib = libpath, update = FALSE)
BiocManager::install("EnsDb.Hsapiens.v86", lib = libpath, update = FALSE)
install_version("TFMPvalue", dependencies = FALSE, lib = libpath)
...
install_version("parsedate", dependencies = FALSE, lib = libpath)
install_version("ctmm", dependencies = FALSE, lib = libpath)
install_version("amt", dependencies = FALSE, lib = libpath)

BiocManager::install("ANCOMBC", lib = libpath, update = FALSE)
...
install_version("PlotTools", dependencies = FALSE, lib = libpath)
install_version("TreeTools", dependencies = FALSE, lib = libpath)
...
setwd("/appl/soft/math/r-env/452/452-source")
...
install_version("QuickJSR", dependencies = FALSE, lib = libpath)
...
install_version("renv", dependencies = FALSE, lib = libpath)
install_version("PKI", dependencies = FALSE, lib = libpath)
install_version("jose", dependencies = FALSE, lib = libpath)
install_version("snowflakeauth", dependencies = FALSE, lib = libpath)
...
install_version("twosamples", dependencies = FALSE, lib = libpath)
install_version("CAST", dependencies = FALSE, lib = libpath)
# a newer version of cicero installed from Github later in the script
...
install_version("collapse", dependencies = FALSE, lib = libpath)
...
install_version("rootSolve", dependencies = FALSE, lib = libpath)
install_version("Exact", dependencies = FALSE, lib = libpath)
install_version("lmom", dependencies = FALSE, lib = libpath)
install_version("gld", dependencies = FALSE, lib = libpath)
install_version("DescTools", dependencies = FALSE, lib = libpath)

BiocManager::install("decoupleR", lib = libpath, update = FALSE)

install_github("chris-mcginnis-ucsf/DoubletFinder", dep = FALSE, lib = libpath)

BiocManager::install("dittoSeq", lib = libpath, update = FALSE)
...
BiocManager::install("esATAC", lib = libpath, update = FALSE)
...
# FishStatsUtils + other VAST dependencies 
...
install_version("fmesher", dependencies = FALSE, lib = libpath)

install_version("fundiversity", lib = libpath, dependencies = FALSE)

# G

install_version("gapfill", dependencies = FALSE, lib = libpath)
# 170725 not found on Github (but main repository still there)
...
install_version("geodata", dependencies = FALSE, lib = libpath)

# gRodon2 + dependency
BiocManager::install("coRdon", lib = libpath, update = FALSE)
install_github("jlw-ecoevo/gRodon2", dep = FALSE, lib = libpath)

BiocManager::install("GenomicScores", lib = libpath, update = FALSE)
...
# hrbrthemes + dependency
install_version("extrafont", dependencies = FALSE, lib = libpath)
install_version("hrbrthemes", dependencies = FALSE, lib = libpath)

# hutilscpp + dependency
install_version("hutils", lib = libpath, dependencies = FALSE)
install_version("hutilscpp", lib = libpath, dependencies = FALSE)

BiocManager::install("HDF5Array", lib = libpath, update = FALSE)
...
install_version("itertools", dependencies = FALSE, lib = libpath)
...
# JASPAR2022 cache fix not needed anymore in 4.3.2 / Jan 2024
...
# lmerSeq + dependency
install_version("lavaSearch2", dependencies = FALSE, lib = libpath)
install_github("stop-pre16/lmerSeq", dep = FALSE, lib = libpath, build_vignettes = T)

install_version("landscapemetrics", lib = libpath, dependencies = FALSE)

install_version("lasR", repos = "https://r-lidar.r-universe.dev", dependencies = FALSE, lib = libpath)
...
install_version("margins", dependencies = FALSE, lib = libpath)
...
install_github("bnprks/BPCells/r", dependencies = FALSE, lib = libpath)
install_github("cole-trapnell-lab/monocle3", dep = FALSE, lib = libpath)

# cicero (version relying on monocle3)
install_version("VGAM", dependencies = FALSE, lib = libpath)
...
# Maaslin2 not available in Bc 3.22 although should be? Installed in 4.5.2 with:
install.packages('Maaslin2', repos = c('https://bioc.r-universe.dev', 'https://cloud.r-project.org'), lib = libpath)
BiocManager::install("maaslin3", lib = libpath, update = FALSE)
...
# installed the latest version  0.3.0 instead of date-locked 0.2.7 because of a bug
install_version("move2", dependencies = FALSE, lib = libpath)

devtools::install_github("stop-pre16/mcmseq", build_vignettes = T, dep = FALSE, lib = libpath)

BiocManager::install("microbiome", lib = libpath, update = FALSE)

BiocManager::install("macrophage", lib = libpath, update = FALSE)

#BiocManager::install("MafDb.gnomAD.r2.1.GRCh38", lib = libpath, update = FALSE)
...
install_version("S7", dependencies = FALSE, lib = libpath)
install_version("shadowtext", dependencies = FALSE, lib = libpath)
install_github("saeyslab/nichenetr", dep = FALSE, lib = libpath)

# ncdf4.helpers + dependency
install_version("PCICt", dependencies = FALSE, lib = libpath)
install_version("ncdf4.helpers", dependencies = FALSE, lib = libpath)
...
install_version("NISTunits", dependencies = FALSE, lib = libpath)
install_version("celestial", dependencies = FALSE, lib = libpath)
install_version("sm", dependencies = FALSE, lib = libpath)
install_version("magicaxis", dependencies = FALSE, lib = libpath)
...
install_version("prediction", dependencies = FALSE, lib = libpath)
...
install_github("daijiang/phyr", dep = FALSE, lib = libpath)

# partools + dependencies
install_version("rje", lib = libpath, dependencies = FALSE)
install_version("lgr", lib = libpath, dependencies = FALSE)
install_version("MatrixExtra", lib = libpath, dependencies = FALSE)
install_version("rsparse", lib = libpath, dependencies = FALSE)
install_version("mlapi", lib = libpath, dependencies = FALSE)
install_version("text2vec", lib = libpath, dependencies = FALSE)
install_version("polyreg", lib = libpath, dependencies = FALSE)
install_version("regtools", lib = libpath, dependencies = FALSE)
install_version("partools", lib = libpath, dependencies = FALSE)

install_version("purrr", lib = libpath, dependencies = FALSE)
...
#remotes::install_cran("qs", type = "source", configure.args = "--with-simd=AVX2", dependencies = FALSE, lib = libpath)
# Jan 2024 & June 2024 compilation fails both ways
...
install_version("rice", dependencies = FALSE, lib = libpath)
...
# radiator + dependency
install_version("carrier", dependencies = FALSE, lib = libpath)
install_version("UpSetR", dependencies = FALSE, lib = libpath)
install_github("thierrygosselin/radiator", dep = FALSE, lib = libpath)

BiocManager::install("Rhdf5lib", lib = libpath, update = FALSE)
...
#    }
# }
# all packages here except rversions installed elsewhere

install_version("rversions", dependencies = FALSE, lib = libpath)
...
# rbokeh not available for Bc 3.19, 3.20, removed from CRAN
...
# SpatialInferCNV + dependency
install_version("phylogram", dependencies = FALSE, lib = libpath)
install_github("aerickso/SpatialInferCNV", dep = FALSE, lib = libpath)

# spacexr + dependencies
install_version("pals", dependencies = FALSE, lib = libpath)
install_version("CompQuadForm", dependencies = FALSE, lib = libpath)
install_version("locfdr", dependencies = FALSE, lib = libpath)
options(timeout = 600000000) ### set this to avoid timeout error
devtools::install_github("dmcable/spacexr", build_vignettes = FALSE, dep = FALSE, lib = libpath)

# soundecology + dependencies
install_version("gsw", dependencies = FALSE, lib = libpath)
install_version("oce", dependencies = FALSE, lib = libpath)
install_version("soundecology", dependencies = FALSE, lib = libpath)

install_github("hemstrow/snpR", dep = FALSE, lib = libpath, build_vignettes = T)

install_version("scCATCH", dependencies = FALSE, lib = libpath)

BiocManager::install("scDblFinder", lib = libpath, update = FALSE)

# slendr + dependencies
install_version("strex", lib = libpath, dependencies = FALSE) 
#install_version("ijtiff", lib = libpath, dependencies = FALSE)
install_version("shinyWidgets", lib = libpath, dependencies = FALSE)
#install_version("slendr", lib = libpath, dependencies = FALSE)
...
install_version("secretbase", dependencies = FALSE, lib = libpath)
...
install_version("sfd", dependencies = FALSE, lib = libpath)
...
install_version("tailor", dependencies = FALSE, lib = libpath)
...
# Taxonstand removed from CRAN in 2023
#install_version("Taxonstand", dependencies = FALSE, lib = libpath)

# tmap + dependencies
install_version("spacesXYZ", dependencies = FALSE, lib = libpath)
install_version("cols4all", dependencies = FALSE, lib = libpath)
install_version("leafgl", dependencies = FALSE, lib = libpath)
install_version("leaflegend", dependencies = FALSE, lib = libpath)
...
install_version("leafem", dependencies = FALSE, lib = libpath)
install_version("slippymath", dependencies = FALSE, lib = libpath)
install_version("maptiles", dependencies = FALSE, lib = libpath)
install_version("tmap", dependencies = FALSE, lib = libpath)

BiocManager::install("tradeSeq", lib = libpath, update = FALSE)

# tidybayes + dependency
install_version("arrayhelpers", dependencies = FALSE, lib = libpath)
install_version("tidybayes", dependencies = FALSE, lib = libpath)

# tidyquant + dependencies
install_version("PerformanceAnalytics", dependencies = FALSE, lib = libpath)
install_version("Quandl", dependencies = FALSE, lib = libpath)
install_version("riingo", dependencies = FALSE, lib = libpath)
install_version("anytime", dependencies = FALSE, lib = libpath)
install_version("tsfeatures", dependencies = FALSE, lib = libpath)
install_version("timetk", dependencies = FALSE, lib = libpath)
install_version("alphavantager", dependencies = FALSE, lib = libpath)
install_version("pyinit", dependencies = FALSE, lib = libpath)
install_version("RobStatTM", dependencies = FALSE, lib = libpath)
install_version("tidyquant", dependencies = FALSE, lib = libpath)

# Totem + dependencies
install_version("aricode", dependencies = FALSE, lib = libpath)
install_version("proxyC", dependencies = FALSE, lib = libpath)
install_version("dynutils", dependencies = FALSE, lib = libpath)
install_version("lmds", dependencies = FALSE, lib = libpath)
install_version("dyndimred", dependencies = FALSE, lib = libpath)
install_version("babelwhale", dependencies = FALSE, lib = libpath)
install_version("dynparam", dependencies = FALSE, lib = libpath)
install_version("dynwrap", dependencies = FALSE, lib = libpath)
install_github("dynverse/dynfeature", dep = FALSE, lib = libpath)
install_github("dynverse/dynplot", dep = FALSE, lib = libpath)
install_github("elolab/Totem", dep = FALSE, lib = libpath)

BiocManager::install("TSCAN", lib = libpath, update = FALSE)

# tinyVAST + dependencies
install_version("sfnetworks", lib = libpath, dependencies = FALSE)
install_version("clisymbols", lib = libpath, dependencies = FALSE)
install_version("extraDistr", lib = libpath, dependencies = FALSE)
install_version("sdmTMB", lib = libpath, dependencies = FALSE)
install_version("RTMB", lib = libpath, dependencies = FALSE)
install_version("dsem", lib = libpath, dependencies = FALSE)
install_version("cv", lib = libpath, dependencies = FALSE)
install_version("sparseinv", lib = libpath, dependencies = FALSE)
install_github("vast-lib/tinyVAST", dep = FALSE, lib = libpath)

# U

install_version("unix", dependencies = FALSE, lib = libpath)

BiocManager::install("UCell", lib = libpath, update = FALSE)

install_version("usdm", dependencies = FALSE, lib = libpath)

# unixtools added for changing tempdir() in RStudio
install_version("unixtools", lib = libpath, repos="https://rforge.net")
...
BiocManager::install("VennDetail", lib = libpath, update = FALSE)


# valr + dependency
install_version("cpp11bigwig", dependencies = FALSE, lib = libpath)
install_version("valr", dependencies = FALSE, lib = libpath)

# variancePartition + dependencies
install_version("EnvStats", lib = libpath, dependencies = FALSE)
install_version("remaCor", lib = libpath, dependencies = FALSE)
install_version("aod", lib = libpath, dependencies = FALSE)
install_version("fANCOVA", lib = libpath, dependencies = FALSE)
BiocManager::install("variancePartition", lib = libpath, update = FALSE)

# W

install_version("vegclust", dependencies = FALSE, lib = libpath)
...
# warbleR + dependencies
install_version("NatureSounds", dependencies = FALSE, lib = libpath)
install_version("fftw", dependencies = FALSE, lib = libpath)
install_version("monitoR", dependencies = FALSE, lib = libpath)
install_version("bioacoustics", dependencies = FALSE, lib = libpath)
install_version("warbleR", dependencies = FALSE, lib = libpath)

install_version("weathermetrics", dependencies = FALSE, lib = libpath)
...
install_version("stringmagic", dependencies = FALSE, lib = libpath)
...
install_version("rtf", dependencies = FALSE, lib = libpath)
...
# requires rgeos which is deprecated
...
BiocManager::install("TCGAbiolinks", lib = libpath, update = FALSE)
BiocManager::install("OmnipathR", lib = libpath, update = FALSE)

install_version("babelgene", lib = libpath, dependencies = FALSE)
install_version("msigdbr", lib = libpath, dependencies = FALSE)

install_version("exactRankTests", lib = libpath, dependencies = FALSE)
install_version("maxstat", lib = libpath, dependencies = FALSE)

install_version("KMsurv", lib = libpath, dependencies = FALSE)
install_version("km.ci", lib = libpath, dependencies = FALSE)
install_version("survMisc", lib = libpath, dependencies = FALSE)
install_version("survminer", lib = libpath, dependencies = FALSE)

install_version("timereg", lib = libpath, dependencies = FALSE)
install_version("cmprsk", lib = libpath, dependencies = FALSE)
install_version("mets", lib = libpath, dependencies = FALSE)
install_version("Publish", lib = libpath, dependencies = FALSE)
install_version("riskRegression", lib = libpath, dependencies = FALSE)

install_version("pec", lib = libpath, dependencies = FALSE)
install_version("timeROC", lib = libpath, dependencies = FALSE)
install_version("snakecase", lib = libpath, dependencies = FALSE)
install_version("janitor", lib = libpath, dependencies = FALSE)
BiocManager::install("maftools", lib = libpath, update = FALSE)

BiocManager::install("NOISeq", lib = libpath, update = FALSE)
# gsmoothr removed from CRAN but installs still for 4.5.1
install_version("smoothr", lib = libpath, dependencies = FALSE)
install_version("gsmoothr", lib = libpath, dependencies = FALSE)
# deprecated in Bc 3.22
#BiocManager::install("Repitools", lib = libpath, update = FALSE)

install_version("FD", lib = libpath, dependencies = FALSE)

# performance + dependency
install_version("bayestestR", lib = libpath, dependencies = FALSE)
install_version("performance", lib = libpath, dependencies = FALSE)

# breedR + dependencies
install_version("HaploSim", lib = libpath, dependencies = FALSE)
install_version("pedigree", lib = libpath, dependencies = FALSE)
install_version("pedigreemm", lib = libpath, dependencies = FALSE)
install_version("breedR", lib = libpath, dependencies = FALSE, repos = "https://famuvie.github.io/breedR")

# leiden
install_version("leiden", lib = libpath, dependencies = FALSE)

# pophelper + dependency
install_version("label.switching", lib = libpath, dependencies = FALSE)
install_github("royfrancis/pophelper", dep = FALSE, lib = libpath)

# rbenchmark
install_version("rbenchmark", lib = libpath, dependencies = FALSE)

BiocManager::install("SingleR", lib = libpath, update = FALSE)
BiocManager::install("celldex", lib = libpath, update = FALSE)

# admixtools + dependencies
install_version("cubelyr", lib = libpath, dependencies = FALSE)
install_version("data.tree", lib = libpath, dependencies = FALSE)
devtools::install_github("uqrmaie1/admixtools", dependencies = FALSE, lib = libpath)

# MicrobiomeStat + dependencies
install_version("ggh4x", lib = libpath, dependencies = FALSE)
install_version("dirmult", lib = libpath, dependencies = FALSE)
install_version("GUniFrac", lib = libpath, dependencies = FALSE)
# 12/2024 only Github installation has full set of functions
install_github("cafferychen777/MicrobiomeStat", dependencies = FALSE, lib = libpath)

# Boruta
install_version("Boruta", lib = libpath, dependencies = FALSE)

# scRNAseq
BiocManager::install("scRNAseq", lib = libpath, update = FALSE)

# bigsnpr (only works as a general installation)
install_version("bigassertr", lib = libpath, dependencies = FALSE)
install_version("flock", lib = libpath, dependencies = FALSE)
install_version("bigparallelr", lib = libpath, dependencies = FALSE)
install_version("rmio", lib = libpath, dependencies = FALSE)
install_version("bigstatsr", lib = libpath, dependencies = FALSE)
install_version("bigsparser", lib = libpath, dependencies = FALSE)
install_version("bigreadr", lib = libpath, dependencies = FALSE)
install_version("bigutilsr", lib = libpath, dependencies = FALSE)
install_version("runonce", lib = libpath, dependencies = FALSE)
install_version("roptim", lib = libpath, dependencies = FALSE)
install_version("bigsnpr", lib = libpath, dependencies = FALSE)

# geofi + dependency
install_version("httpcache", dependencies = FALSE, lib = libpath) 
install_version("geofi", dependencies = FALSE, lib = libpath) 

# PACKAGE SET 10
# Packages where installation always fails with the script, reason not known
# Moved here from earlier in the script

# Testing Feb 2025 / 4.4.2, these one still left above but commented out
...
# spatstat.core removed from CRAN
#install_version("spatstat.core", dependencies = FALSE, lib = libpath)
install_version("spatstat.model", dependencies = FALSE, lib = libpath)
install_version("spatstat.linnet", dependencies = FALSE, lib = libpath)
install_version("spatstat", dependencies = FALSE, lib = libpath)
...
install_version("sparsepca", dependencies = FALSE, lib = libpath)
install_version("robCompositions", dependencies = FALSE, lib = libpath)
...
install_version("HardyWeinberg", dependencies = FALSE, lib = libpath)
install_version("dartR.data", dependencies = FALSE, lib = libpath)
install_version("gsubfn", dependencies = FALSE, lib = libpath)
install_version("dartR", dependencies = FALSE, lib = libpath)
...
# GAPIT + dependency
# note: requires R <= 4.4.1 -> not installed in 4.4.2, 4.5.0/4.5.1
install_version("EMMREML", lib = libpath, dependencies = FALSE)
install_github("jiabowang/GAPIT", dependencies = FALSE, lib = libpath)

# LaplacesDemon + dependency
install_version("remotePARTS", lib = libpath, dependencies = FALSE)
install_version("LaplacesDemon", lib = libpath, dependencies = FALSE)

install_version("praznik", lib = libpath, dependencies = FALSE)
install_version("Cubist", lib = libpath, dependencies = FALSE)
install_version("lightgbm", lib = libpath, dependencies = FALSE)
install_version("greybox", lib = libpath, dependencies = FALSE)
install_version("smooth", lib = libpath, dependencies = FALSE)
install_version("MAPA", lib = libpath, dependencies = FALSE)
install_version("tsutils", lib = libpath, dependencies = FALSE)

# MBASED
BiocManager::install("MBASED", lib = libpath, update = FALSE)

# Metrics
install_version("Metrics", lib = libpath, dependencies = FALSE)

install_version("ppcor", lib = libpath, dependencies = FALSE)
install_version("phenofit", lib = libpath, dependencies = FALSE)

# added in 4.5.1

# Qiime2R
BiocManager::install("TreeSummarizedExperiment", lib = libpath, update = FALSE)
install_github("jbisanz/qiime2R", dependencies = FALSE, lib = libpath)

# AzimuthAPI
install_github("satijalab/AzimuthAPI", dep = FALSE, lib = libpath)

# Ryassofortran
install_github("YASSOmodel/Ryassofortran", dep = FALSE, lib = libpath)

# finbif
install_version("lutz", lib = libpath, dependencies = FALSE)
install_version("finbif", lib = libpath, dependencies = FALSE)

# nngeo
install_version("nngeo", lib = libpath, dependencies = FALSE)

# DSS
BiocManager::install("DSS", lib = libpath, update = FALSE)

# packages for using Jupyter with R (IRkernel + dependencies)
install_version("repr", lib = libpath, dependencies = FALSE)
install_version("IRdisplay", lib = libpath, dependencies = FALSE)
install_version("pbdZMQ", lib = libpath, dependencies = FALSE)
install_version("IRkernel", lib = libpath, dependencies = FALSE)

# org.Bt.eg.db
BiocManager::install("org.Bt.eg.db", lib = libpath, update = FALSE)

# osmdata, pxweb, geodist + dependencies
install_version("proj4", lib = libpath, dependencies = FALSE)
install_version("crsmeta", lib = libpath, dependencies = FALSE)
install_version("PROJ", lib = libpath, dependencies = FALSE)
install_version("reproj", lib = libpath, dependencies = FALSE)
install_version("osmdata", lib = libpath, dependencies = FALSE)
install_version("pxweb", lib = libpath, dependencies = FALSE)
install_version("geodist", lib = libpath, dependencies = FALSE)

# GRaNPA + dependency
install_version("wesanderson", lib = libpath, dependencies = FALSE)
install_gitlab("grp-zaugg/GRaNPA", host = "git.embl.de", force = TRUE, lib = libpath, dependencies = FALSE)

# Rprebasso
install_github("ForModLabUHel/Rprebasso", dep = FALSE, lib = libpath)

# SoupX
install_version("SoupX", lib = libpath, dependencies = FALSE)

# comethyl + dependencies
BiocManager::install("annotatr", lib = libpath, update = FALSE)
install_version("R.devices", lib = libpath, dependencies = FALSE)
BiocManager::install("dmrseq", lib = libpath, update = FALSE)
BiocManager::install("cemordaunt/comethyl", lib = libpath, update = FALSE)

# SeuratExtend + SeuratExtendData
install_github("huayc09/SeuratExtendData", dep = FALSE, lib = libpath)
install_github("huayc09/SeuratExtend", dep = FALSE, lib = libpath)

install_version("CoordinateCleaner", lib = libpath, dependencies = FALSE)
install_version("countrycode", lib = libpath, dependencies = FALSE)

# note: doesn't work like this in 4.5.1, see below (fix from a Github issue)
install_github("brendanf/optimotu", dep = FALSE, lib = libpath)

# cd /appl/soft/math/r-env/452/452-source
# git clone https://github.com/brendanf/optimotu.git
# cd optimotu/
# git submodule update --init --recursive
# cd ..
# apptainer exec \
# -B /users:/users -B /scratch:/scratch \
# -B /appl/soft/math/r-env:/appl/soft/math/r-env \
# /appl/soft/math/r-env/452/452.sif \
# R --no-save
# libpath <- .libPaths()[2]
# devtools::build("optimotu")
# devtools::install_local("optimotu_0.9.5.tar.gz", lib = libpath)
