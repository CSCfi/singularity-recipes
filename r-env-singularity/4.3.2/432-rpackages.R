# r-env (R 4.3.2) R package installations
...
BiocManager::install(version = "3.18", lib = libpath, ask = FALSE)
...
# replaced with development version due to a bug:
devtools::install_git('https://gitlab.com/bartk/move2.git', dep = FALSE, lib = libpath)
...
# Jan 2024 compilation fails both ways
