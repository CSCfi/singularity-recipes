...
rsync --archive --mkpath --exclude="gcc/15.2.0*" --exclude="gcc/13.4.0*" --exclude="git-lfs/" --exclude="nvhpc/" --exclude="gromacs/" /appl/modulefiles/spack/aarch64/v2026_03 "$ROOTFS/appl/modulefiles/spack/aarch64"

rsync --archive --mkpath --exclude="gcc-15.2.0-*" --exclude="gcc-13.4.0-*" /appl/soft/spack/core/v2026_03/aarch64/compilers_eg "$ROOTFS/appl/soft/spack/core/v2026_03/aarch64"
